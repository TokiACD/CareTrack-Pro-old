  ...
  useEffect(() => {
    if (draftData && !isEditMode && assessmentData) {
      setFormData({
        ...
        overallRating: draftData.overallRating as CompetencyLevel,
        knowledgeResponses: draftData.knowledgeResponses,
        practicalResponses: draftData.practicalResponses.map((resp: any) => ({
          ...resp,
          rating: resp.rating as PracticalRating
        })),
                              ...
                              <Box display="flex" gap={1}>
                                ...
                                {index < assessment.knowledgeQuestions.length - 1 ? (
                                  <Button
                                    variant="contained"
                                    size="small"
                                    onClick={() => handleQuestionNext(questionId, nextQuestionId || undefined)}
                              ...
                              <Box display="flex" gap={1}>
                                ...
                                {index < assessment.practicalSkills.length - 1 ? (
                                  <Button
                                    variant="contained"
                                    size="small"
                                    onClick={() => handleQuestionNext(skillId, nextSkillId || undefined)}
                                    endIcon={<NavigateNextIcon />}
                                  >
                                    Next Skill
                                  </Button>
